#
#  Be sure to run `pod spec lint Trekker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/awkward/Trekker"
  ...
  s.source       = { :git => "https://github.com/awkward/Trekker.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Trekker", "Trekker/**/*.{h,m,swift}"
